...
* Consent2Share UI 0.6.0: [https://github.com/bhits/c2s-ui/releases/tag/0.6.0](https://github.com/bhits/c2s-ui/releases/tag/0.6.0)
* Consent2Share UI API 0.6.0: [https://github.com/bhits/c2s-ui-api/releases/tag/0.6.0](https://github.com/bhits/c2s-ui-api/releases/tag/0.6.0)
* Configuration Server 0.4.0: [https://github.com/bhits/config-server/releases/tag/0.4.0](https://github.com/bhits/config-server/releases/tag/0.4.0)
* Context Handler 2.3.0: [https://github.com/bhits/context-handler/releases/tag/2.3.0](https://github.com/bhits/context-handler/releases/tag/2.3.0)
* Discovery Server 0.12.0: [https://github.com/bhits/discovery-server/releases/tag/0.12.0](https://github.com/bhits/discovery-server/releases/tag/0.12.0)
* Document Validator API 1.1.0: [https://github.com/bhits/document-validator/releases/tag/1.1.0](https://github.com/bhits/document-validator/releases/tag/1.1.0)
* Document Segmentation Service 2.4.0: [https://github.com/bhits/dss/releases/tag/2.4.0](https://github.com/bhits/dss/releases/tag/2.4.0)
* Edge Server 0.20.0: [https://github.com/bhits/edge-server/releases/tag/0.20.0](https://github.com/bhits/edge-server/releases/tag/0.20.0)
* Dockerized JBoss Drools Guvnor 5.5.0: [https://github.com/bhits/dockerized-drools-guvnor/releases/tag/5.5.0](https://github.com/bhits/dockerized-drools-guvnor/releases/tag/5.5.0)
* IExHub PIX PDQ 0.1.0: [https://github.com/bhits/iexhub-pix-pdq/releases/tag/0.1.0](https://github.com/bhits/iexhub-pix-pdq/releases/tag/0.1.0)
* IExHub XDSB 0.1.0: [https://github.com/bhits/iexhub-xdsdb/releases/tag/0.1.0](https://github.com/bhits/iexhub-xdsb/releases/tag/0.1.0)
* HAPI FHIR 2.3-01 : [https://github.com/bhits/hapi-fhir/releases/tag/2.3-01](https://github.com/bhits/hapi-fhir/releases/tag/2.3-01)
* Master UI 0.2.0: [https://github.com/bhits/master-ui/releases/tag/0.2.0](https://github.com/bhits/master-ui/releases/tag/0.2.0)
* Master UI API 0.2.0: [https://github.com/bhits/master-ui-api/releases/tag/0.2.0](https://github.com/bhits/master-ui-api/releases/tag/0.2.0)
* Patient Consent Management Service 2.4.0: [https://github.com/bhits/pcm/releases/tag/2.4.0](https://github.com/bhits/pcm/releases/tag/2.4.0)
* Policy Enforcement Point 2.1.0: [https://github.com/bhits/pep/releases/tag/2.1.0](https://github.com/bhits/pep/releases/tag/2.1.0)
* Patient Health Record 2.2.0: [https://github.com/bhits/phr/releases/tag/2.2.0](https://github.com/bhits/phr/releases/tag/2.2.0)
* Provider Lookup Service 3.3.0: [https://github.com/bhits/pls/releases/tag/3.3.0](https://github.com/bhits/pls/releases/tag/3.3.0)
* Provider UI 0.3.0: [https://github.com/bhits/provider-ui/releases/tag/0.3.0](https://github.com/bhits/provider-ui/releases/tag/0.3.0)
* Provider UI API 0.3.0: [https://github.com/bhits/provider-ui-api/releases/tag/0.3.0](https://github.com/bhits/provider-ui-api/releases/tag/0.3.0)
* Staff UI 0.4.0: [https://github.com/bhits/staff-ui/releases/tag/0.4.0](https://github.com/bhits/staff-ui/releases/tag/0.4.0)
* Staff  API 0.4.0: [https://github.com/bhits/staff-ui-api/releases/tag/0.4.0](https://github.com/bhits/staff-ui-api/releases/tag/0.4.0)
* Try Policy 2.2.0: [https://github.com/bhits/try-policy/releases/tag/2.2.0](https://github.com/bhits/try-policy/releases/tag/2.2.0)
* CloudFoundry User Account and Authentication (UAA) Server 3.4.1-08: [https://github.com/bhits/uaa/releases/tag/3.4.1-08](https://github.com/bhits/uaa/releases/tag/3.4.1-08)
* User Management Service 0.4.0: [https://github.com/bhits/ums/releases/tag/0.4.0](https://github.com/bhits/ums/releases/tag/0.4.0)
* Value Set Service 0.5.0: [https://github.com/bhits/vss/releases/tag/0.5.0](https://github.com/bhits/vss/releases/tag/0.5.0)
* Common Libraries 1.16.0: [https://github.com/bhits/common-libraries/releases/tag/1.16.0](https://github.com/bhits/common-libraries/releases/tag/1.16.0)
* Configuration Data 3.4.0: [https://github.com/bhits/c2s-config-data/releases/tag/3.4.0](https://github.com/bhits/c2s-config-data/releases/tag/3.4.0)
...
* Consent2Share UI 0.5.0: [https://github.com/bhits/c2s-ui/releases/tag/0.5.0](https://github.com/bhits/c2s-ui/releases/tag/0.5.0)
* Consent2Share UI API 0.5.0: [https://github.com/bhits/c2s-ui-api/releases/tag/0.5.0](https://github.com/bhits/c2s-ui-api/releases/tag/0.5.0)
...
* Context Handler 2.2.0: [https://github.com/bhits/context-handler/releases/tag/2.2.0](https://github.com/bhits/context-handler/releases/tag/2.2.0)
...
* Document Segmentation Service 2.3.0: [https://github.com/bhits/dss/releases/tag/2.3.0](https://github.com/bhits/dss/releases/tag/2.3.0)
* Edge Server 0.19.0: [https://github.com/bhits/edge-server/releases/tag/0.19.0](https://github.com/bhits/edge-server/releases/tag/0.19.0)
* Dockerized JBoss Drools Guvnor 5.5.0: [https://github.com/bhits/dockerized-drools-guvnor/releases/tag/5.5.0](https://github.com/bhits/dockerized-drools-guvnor/releases/tag/5.5.0)
* HAPI FHIR 2.3-01 : [https://github.com/bhits/hapi-fhir/releases/tag/2.3-01](https://github.com/bhits/hapi-fhir/releases/tag/2.3-01)
* Master UI 0.1.0: [https://github.com/bhits/master-ui/releases/tag/0.1.0](https://github.com/bhits/master-ui/releases/tag/0.1.0)
* Master UI API 0.1.0: [https://github.com/bhits/master-ui-api/releases/tag/0.1.0](https://github.com/bhits/master-ui-api/releases/tag/0.1.0)
* Patient Consent Management Service 2.3.0: [https://github.com/bhits/pcm/releases/tag/2.3.0](https://github.com/bhits/pcm/releases/tag/2.3.0)
* Policy Enforcement Point 2.0.0: [https://github.com/bhits/pep/releases/tag/2.0.0](https://github.com/bhits/pep/releases/tag/2.0.0)
* Patient Health Record 2.1.0: [https://github.com/bhits/phr/releases/tag/2.1.0](https://github.com/bhits/phr/releases/tag/2.1.0)
* Provider Lookup Service 3.2.0: [https://github.com/bhits/pls/releases/tag/3.2.0](https://github.com/bhits/pls/releases/tag/3.2.0)
* Provider UI 0.2.0: [https://github.com/bhits/provider-ui/releases/tag/0.2.0](https://github.com/bhits/provider-ui/releases/tag/0.2.0)
* Provider UI API 0.2.0: [https://github.com/bhits/provider-ui-api/releases/tag/0.2.0](https://github.com/bhits/provider-ui-api/releases/tag/0.2.0)
* Staff UI 0.3.0: [https://github.com/bhits/staff-ui/releases/tag/0.3.0](https://github.com/bhits/staff-ui/releases/tag/0.3.0)
* Staff  API 0.3.0: [https://github.com/bhits/staff-ui-api/releases/tag/0.3.0](https://github.com/bhits/staff-ui-api/releases/tag/0.3.0)
* Try Policy 2.1.0: [https://github.com/bhits/try-policy/releases/tag/2.1.0](https://github.com/bhits/try-policy/releases/tag/2.1.0)
* CloudFoundry User Account and Authentication (UAA) Server 3.4.1-08: [https://github.com/bhits/uaa/releases/tag/3.4.1-08](https://github.com/bhits/uaa/releases/tag/3.4.1-08)
* User Management Service 0.3.0: [https://github.com/bhits/ums/releases/tag/0.3.0](https://github.com/bhits/ums/releases/tag/0.3.0)
* Value Set Service 0.4.0: [https://github.com/bhits/vss/releases/tag/0.4.0](https://github.com/bhits/vss/releases/tag/0.4.0)
* Common Libraries 1.13.0: [https://github.com/bhits/common-libraries/releases/tag/1.13.0](https://github.com/bhits/common-libraries/releases/tag/1.13.0)
* Configuration Data 3.3.0: [https://github.com/bhits/c2s-config-data/releases/tag/3.3.0](https://github.com/bhits/c2s-config-data/releases/tag/3.3.0)
...
* Consent2Share UI 0.4.0: [https://github.com/bhits/c2s-ui/releases/tag/0.4.0](https://github.com/bhits/c2s-ui/releases/tag/0.4.0)
* Consent2Share UI API 0.4.0: [https://github.com/bhits/c2s-ui-api/releases/tag/0.4.0](https://github.com/bhits/c2s-ui-api/releases/tag/0.4.0)
* Configuration Server 0.3.0: [https://github.com/bhits/config-server/releases/tag/0.3.0](https://github.com/bhits/config-server/releases/tag/0.3.0)
* Context Handler 2.1.0: [https://github.com/bhits/context-handler/releases/tag/2.1.0](https://github.com/bhits/context-handler/releases/tag/2.1.0)
* Discovery Server 0.11.0: [https://github.com/bhits/discovery-server/releases/tag/0.11.0](https://github.com/bhits/discovery-server/releases/tag/0.11.0)
* Document Validator API 1.0.0: [https://github.com/bhits/document-validator/releases/tag/1.0.0](https://github.com/bhits/document-validator/releases/tag/1.0.0)
* Document Segmentation Service 2.2.0: [https://github.com/bhits/dss/releases/tag/2.2.0](https://github.com/bhits/dss/releases/tag/2.2.0)
* Edge Server 0.18.0: [https://github.com/bhits/edge-server/releases/tag/0.18.0](https://github.com/bhits/edge-server/releases/tag/0.18.0)
* Dockerized JBoss Drools Guvnor 5.5.0: [https://github.com/bhits/dockerized-drools-guvnor/releases/tag/5.5.0](https://github.com/bhits/dockerized-drools-guvnor/releases/tag/5.5.0)
* HAPI FHIR 2.3-01 : [https://github.com/bhits/hapi-fhir/releases/tag/2.3-01](https://github.com/bhits/hapi-fhir/releases/tag/2.3-01)
* Patient Consent Management Service 2.2.0: [https://github.com/bhits/pcm/releases/tag/2.2.0](https://github.com/bhits/pcm/releases/tag/2.2.0)
* Policy Enforcement Point 2.0.0: [https://github.com/bhits/pep/releases/tag/2.0.0](https://github.com/bhits/pep/releases/tag/2.0.0)
* Patient Health Record 2.0.0: [https://github.com/bhits/phr/releases/tag/2.0.0](https://github.com/bhits/phr/releases/tag/2.0.0)
* Provider Lookup Service 3.1.0: [https://github.com/bhits/pls/releases/tag/3.1.0](https://github.com/bhits/pls/releases/tag/3.1.0)
* Provider UI 0.1.0: [https://github.com/bhits/provider-ui/releases/tag/0.1.0](https://github.com/bhits/provider-ui/releases/tag/0.1.0)
* Provider UI API 0.1.0: [https://github.com/bhits/provider-ui-api/releases/tag/0.1.0](https://github.com/bhits/provider-ui-api/releases/tag/0.1.0)
* Staff UI 0.2.0: [https://github.com/bhits/staff-ui/releases/tag/0.2.0](https://github.com/bhits/staff-ui/releases/tag/0.2.0)
* Staff  API 0.2.0: [https://github.com/bhits/staff-ui-api/releases/tag/0.2.0](https://github.com/bhits/staff-ui-api/releases/tag/0.2.0)
* Try Policy 2.0.0: [https://github.com/bhits/try-policy/releases/tag/2.0.0](https://github.com/bhits/try-policy/releases/tag/2.0.0)
* CloudFoundry User Account and Authentication (UAA) Server 3.4.1-07: [https://github.com/bhits/uaa/releases/tag/3.4.1-07](https://github.com/bhits/uaa/releases/tag/3.4.1-07)
* User Management Service 0.2.0: [https://github.com/bhits/ums/releases/tag/0.2.0](https://github.com/bhits/ums/releases/tag/0.2.0)
* Value Set Service 0.4.0: [https://github.com/bhits/vss/releases/tag/0.4.0](https://github.com/bhits/vss/releases/tag/0.4.0)
* Common Libraries 1.12.0: [https://github.com/bhits/common-libraries/releases/tag/1.12.0](https://github.com/bhits/common-libraries/releases/tag/1.12.0)
* Configuration Data 3.2.0: [https://github.com/bhits/c2s-config-data/releases/tag/3.2.0](https://github.com/bhits/c2s-config-data/releases/tag/3.2.0)
...
* Consent2Share UI 0.3.0: [https://github.com/bhits/c2s-ui/releases/tag/0.3.0](https://github.com/bhits/c2s-ui/releases/tag/0.1.0)
* Consent2Share UI API 0.3.0: [https://github.com/bhits/c2s-ui-api/releases/tag/0.3.0](https://github.com/bhits/c2s-ui-api/releases/tag/0.1.0)
* Configuration Server 0.3.0: [https://github.com/bhits/config-server/releases/tag/0.3.0](https://github.com/bhits/config-server/releases/tag/0.3.0)
* Context Handler 2.0.0: [https://github.com/bhits/context-handler/releases/tag/2.0.0](https://github.com/bhits/context-handler/releases/tag/2.0.0)
* Discovery Server 0.11.0: [https://github.com/bhits/discovery-server/releases/tag/0.11.0](https://github.com/bhits/discovery-server/releases/tag/0.11.0)
...
* Document Segmentation Service API 2.1.0: [https://github.com/bhits/dss/releases/tag/2.1.0](https://github.com/bhits/dss/releases/tag/2.1.0)
* Edge Server 0.17.0: [https://github.com/bhits/edge-server/releases/tag/0.17.0](https://github.com/bhits/edge-server/releases/tag/0.17.0)
* Dockerized JBoss Drools Guvnor 5.5.0: [https://github.com/bhits/dockerized-drools-guvnor/releases/tag/5.5.0](https://github.com/bhits/dockerized-drools-guvnor/releases/tag/5.5.0)
* HAPI FHIR 2.3-01 : [https://github.com/bhits/hapi-fhir/releases/tag/2.3-01](https://github.com/bhits/hapi-fhir/releases/tag/2.3-01)
* Patient Consent Management Service 2.1.0: [https://github.com/bhits/pcm/releases/tag/2.1.0](https://github.com/bhits/pcm/releases/tag/2.1.0)
...
* Staff UI 0.1.0: [https://github.com/bhits/staff-ui/releases/tag/0.1.0](https://github.com/bhits/staff-ui/releases/tag/0.1.0)
* Staff UI API 0.1.0: [https://github.com/bhits/staff-ui-api/releases/tag/0.1.0](https://github.com/bhits/staff-ui-api/releases/tag/0.1.0)
* CloudFoundry User Account and Authentication (UAA) Server 3.4.1-06: [https://github.com/bhits/uaa/releases/tag/3.4.1-06](https://github.com/bhits/uaa/releases/tag/3.4.1-06)
* User Management Service 0.1.0: [https://github.com/bhits/ums/releases/tag/0.1.0](https://github.com/bhits/ums/releases/tag/0.1.0)
* Value Set Service 0.3.0: [https://github.com/bhits/vss/releases/tag/0.3.0](https://github.com/bhits/vss/releases/tag/0.3.0)
* Common Libraries 1.11.0: [https://github.com/bhits/common-libraries/releases/tag/1.11.0](https://github.com/bhits/common-libraries/releases/tag/1.11.0)
* Configuration Data 3.1.0: [https://github.com/bhits/c2s-config-data/releases/tag/3.1.0](https://github.com/bhits/c2s-config-data/releases/tag/3.1.0)
