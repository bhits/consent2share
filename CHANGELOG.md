<a name="2.1.3"></a>
# Consent2Share 2.1.3 (2017-09-11)

### Features

* **Patient Consent Management API:**  Uses [Apache PDFBox](https://pdfbox.apache.org/) library that is an open source Java tool for working with PDF format documents to support creation of PDF documents.

### NOTES:

Consent2Share 2.1.3 release includes:
...
* Patient Consent Management API 1.25.0: [https://github.com/bhits/pcm-api/releases/tag/1.25.0](https://github.com/bhits/pcm-api/releases/tag/1.25.0)
