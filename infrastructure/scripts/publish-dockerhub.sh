...
docker tag bhitsdev/document-validator bhitsdev/document-validator:${DOCUMENT_VALIDATOR_VERSION}
docker tag bhits/dss bhitsdev/dss:${DSS_VERSION};
docker tag bhits/edge-server bhitsdev/edge-server:${EDGE_SERVER_VERSION};
docker tag bhits/pcm bhitsdev/pcm:${EDGE_SERVER_VERSION};
...
docker tag bhitsdev/provider-ui-api bhitsdev/provider-ui-api:${PROVIDER_UI_API_VERSION}
docker tag bhitsdev/provider-ui bhitsdev/provider-ui:${PROVIDER_UI_VERSION}
...
docker tag bhitsdev/try-policy  bhitsdev/try-policy:${TRY_POLICY_VERSION}
